# -*- coding: utf-8 -*-
# @Time    : 2018/11/16 20:26
# @Author  : Tianchiyue
# @File    : esim_word_char.py
...
def esim_word_char(embedding_matrix, char_embedding_matrix, config):
    ...
    dense = Concatenate()([dense, dense_char])
    ...
    model = Model(inputs=[q1, q2, q1_char, q2_char], outputs=predictions)
...
def cross_validation():
    ...
    train_x = [train_word_x1, train_word_x2, train_char_x1, train_char_x2]
    test_x = [test_word_x1, test_word_x2, test_char_x1, test_char_x2]
    config = esim_config
